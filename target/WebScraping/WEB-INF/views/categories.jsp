...
<div class="lockscreen-wrapper">
    ...
    <!-- User name -->
    <div class="lockscreen-name">Choisir une catégorie :</div>

    <!-- START LOCK SCREEN ITEM -->
    <div class="lockscreen-item">

        <!-- lockscreen credentials (contains the form) -->
        <form action="<c:out value="categorie/sous-categorie"/>" method="post"
              style="display: flex; justify-content: center;">
            <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" name="id_cat">
    ...
    <div class="lockscreen-footer text-center">
        Copyright &copy; 2019-2020 <b><a href="http://localhost:8080/WebScraping_war/"
                                         class="text-black">WebScraping</a></b><br>
