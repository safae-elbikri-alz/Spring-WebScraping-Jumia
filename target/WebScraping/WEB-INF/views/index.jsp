    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="<c:out value="resources/dist/img/user2-160x160.jpg"/>" class="img-circle elevation-2"
                         alt="User Image">
                </div>
                <div class="info">
                ...
                <table id="table_produits" class="display">
                    ...
                    <c:forEach items="${prodlist}" var="prod">
                        <tr>
                            ...
                            <td><a class="btn btn-primary" href="${prod.lien}" role="button" target="_blank">Visiter</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
